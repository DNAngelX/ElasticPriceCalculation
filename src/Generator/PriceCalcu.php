        ...
        if(is_array($resultData['documents']) && count($resultData['documents']) > 0)
        {
            ...
            foreach($resultData['documents'] as $item)
            {
                ...
                $data = [
                    ...
                    'Lagerreichweite 90T Durchschnitt' => '',
                    'Lagerreichweite 30T Durchschnitt' => '',
                    'Preis min AYN'     => str_replace(".",",",round(((((($item['data']['variation']['purchasePrice']+$item['data']['variation']['transportationCosts'])/100*($item['data']['variation']['operatingCosts']+100)))*1.1)*1.19)*1.08,2)),
                    'Preis min eBay / Shop'     => str_replace(".",",",round(((((($item['data']['variation']['purchasePrice']+$item['data']['variation']['transportationCosts'])/100*($item['data']['variation']['operatingCosts']+100)))*1.1)*1.19)*1.10,2)), 
                    'Preis min Amazon'  => str_replace(".",",",round(((((($item['data']['variation']['purchasePrice']+$item['data']['variation']['transportationCosts'])/100*($item['data']['variation']['operatingCosts']+100)))*1.1)*1.19)*1.19,2)),
